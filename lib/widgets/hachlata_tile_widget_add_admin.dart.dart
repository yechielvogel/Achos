...
class AddHachlataTileWidgetAdmin extends StatefulWidget {
  ...
  @override
  _AddHachlataTileWidgetAdminState createState() => _AddHachlataTileWidgetAdminState();
}

class _AddHachlataTileWidgetAdminState extends State<AddHachlataTileWidgetAdmin> {
